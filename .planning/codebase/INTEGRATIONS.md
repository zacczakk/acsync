...
- Corp Proxy Bedrock — network proxy to AWS Bedrock models
  - SDK/Client: `@ai-sdk/openai-compatible` npm package
  - Auth: `CORP_BEDROCK_API_KEY` env var
  - Base URL: `${CORP_BASE_URL}/model/`
  - Models: Claude Sonnet 4.5, Claude Haiku 4.5, Claude Opus 4.5
  - Config: `configs/settings/opencode.json` → `provider.provider-bedrock`

- Corp Proxy Foundry — network proxy to Anthropic via model proxy
  ...
  - Config: `configs/settings/opencode.json` → `provider.provider-foundry`
