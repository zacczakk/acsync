...
- Required env vars: `TAVILY_API_KEY`, `CONTEXT7_API_KEY`, `provider_BEDROCK_API_KEY`, `FOUNDRY_TOKEN`, `FOUNDRY_HOST`, `provider_BASE_URL_PROD`
- SSL: `SSL_CERT_FILE` and `NODE_EXTRA_CA_CERTS` → `~/.claude/cacert.pem` (network proxy)
