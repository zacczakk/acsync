...
3. **Secret leak via incomplete redaction** — Post-write content scan for all known secret values. `FOUNDRY_TOKEN` ↔ `FOUNDRY_TOKEN` alias is a first-class mapping. Pre-commit hook as safety net.
