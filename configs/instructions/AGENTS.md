...
- WebFetch: blocked in Claude Code (network proxy); works fine in OpenCode. Use Tavily for search regardless (better structured results).
...
## Web Access
WebFetch blocked (network proxy). Use Tavily MCP
